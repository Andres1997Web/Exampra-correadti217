...
<html>
    ...
    <body>
    <marquee><h1>Consulta Pacientes JSP</h1></marquee>
    <center><h1>Sistema Control JSP-WEB</h1></center>
    <hr>
    ...
    <%
       Conexion conexion=new Conexion("jdbc:mysql://localhost/dbdticorrea","root", "");  
           String consultaAlumnos="SELECT * FROM pacientes";//consulta que llama los campos y registros de tabla
    ...
    <div class="container">
           <div class="jumbotron">
               <center><h2>Consulta de pacientes en sistema</h2></center>
               <hr>
